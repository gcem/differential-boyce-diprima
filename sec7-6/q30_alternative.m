# this doesn't work on GNU Octave version 6.2.0 due to a bug with
# nested functions.
# it works on my version of octave, built from source
# (built on 07.12.2021 from changeset 30444:33a53086c0fb)
...
function q30
  ...
  title({'y_1 and y_2 vs t';'CLICK HERE TO PLAY'})

  set(gca, 'ButtonDownFcn', @anim);
